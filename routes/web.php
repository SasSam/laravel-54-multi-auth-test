...
Route::group(['prefix' => ''], function () {
	...
	Route::group(['prefix' => '/employees', 'middleware' => 'web'], function () {
		...
		Route::get('password/reset', 'Employee\Auth\ForgotPasswordController@showLinkRequestForm')->name('employee.password.request');
	...
	Route::group(['prefix' => '/customers', 'middleware' => 'web'], function () {
		...
		// Password Reset Routes...
		Route::get('password/reset', 'Customer\Auth\ForgotPasswordController@showLinkRequestForm')->name('customer.password.request');
